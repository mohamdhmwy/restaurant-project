    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-sample" action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="title" class="form-control" id="input" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="dis" class="form-control" id="input" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="category_id" id="input" required>
                                        ...
                                        @foreach ($category as $category)
                                            <option id="input" value="{{ $category->id }}">{{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="is_showing"
                                                id="membershipRadios1"> Showing </label>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="spe"
                                                id="membershipRadios2"> Special </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="price" id="input" class="form-control" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" id="input" name="dis_price" class="form-control" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control type"  name="type[]" multiple="multiple"
                                        ...
                                        <option  value="Ice_Drinks">Ice Drinks</option>
