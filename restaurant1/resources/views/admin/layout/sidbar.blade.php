<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('isadmin') }}">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('coubon.index') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-table-large"></i>
                </span>
                <span class="menu-title">Coubon</span>
            </a>
        </li>
        <li class="nav-item menu-items">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('worktime.index') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-contacts"></i>
                </span>
                <span class="menu-title">Time Work</span>
            </a>
        </li>
        <li class="nav-item menu-items">
