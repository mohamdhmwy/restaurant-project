                ...
                <div class="w-full flex-1 mt-8">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mx-auto max-w-xs">
                            ...
                            @enderror
                            <input id="password" style="margin-top: 15px"
                                class="@error('password') is-invalid @enderror w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                            ...
                            @enderror
                            <input id="password-confirm" style="margin-top: 15px"
