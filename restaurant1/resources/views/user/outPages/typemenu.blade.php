            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="big-post-content text-center mb-50">
                        ...
                        <a href="{{ route('show_Reservation_Form') }}" class="btn bueno-btn" style="background-color: #18181c">Make a Reservation</a>
                    </div>
                </div>
                <div class="col-12 col-md-6">
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-12 d-flex justify-content-center">
                <ul id="menu-flters">
                    <li style="font-size: 50px" data-filter="filter-starters" class="">{{ $class }}</li>
                </ul>
            </div>
        </div>
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">

            @foreach ($typemenu as $menus)
                    ...
                    <a href="{{ route('singel_menu', [$menus->category->slug, $menus->slug]) }}">
                        <div class="col-lg-6 menu-item filter-starters">
                            ...
                            <div class="menu-content">
                                <a href="{{ route('singel_menu', [$menus->category->slug, $menus->slug]) }}"
                                    style="margin-right: 50%">{{ $menus->name }}</a><span>${{ $menus->price }}</span>
                            </div>
...
<section id="specials" class="specials" style="background-color: black">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>Bestseller</h2>
            <p>Check Our Bestseller Products</p>
        </div>
